...
if ($nome!="" and $email!="" and $sobrenome!="")
	...
	if (mail($mail_destino, "Formulário do SITE: $assunto", $msg, "From:$nome<$email>"))
		...
		echo 
			...
			echo '<a href="Melhores_praticas_para_criar_um_e_commerce_ninja.pdf" target="_blank"><font style="font-family: verdana; font-weight: 900; color:red; font-size: 40px;">Clique aqui para baixar o PDF.</font></a><br>';
