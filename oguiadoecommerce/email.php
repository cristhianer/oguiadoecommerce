...
if ($nome!="" and $email!="" and $sobrenome!="")
	...
	if (mail($mail_destino, "Formulário do SITE: $assunto", $msg, "From:$nome<$email>"))
		...
		echo 
			...
			echo "Obrigado!<br>vc receber&aacute; um e-mail de confirma&ccedil;	&atilde;o desta mensagem<br><br>endere&ccedil;o ip: <b>$ip</b></font> 
			";
...
// Define uma função que poderá ser usada para validar e-mails usando regexp
	...
	echo "O e-mail inserido &eacute; invalido!";
	}
